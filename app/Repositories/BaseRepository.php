...
abstract class BaseRepository extends \Prettus\Repository\Eloquent\BaseRepository
{
    ...
    /**
     * [batchDelete 批量删除, tian add]
     * @param  [type] $field [description]
     * @param  [type] $arr   [description]
     * @return [type]        [description]
     */
    public function batchDelete($field, $arr)
    {
        $this->applyScope();
        $temporarySkipPresenter = $this->skipPresenter;
        $this->skipPresenter(true);

        $deleted = $this->model->whereIn($field, $arr)->delete();
    ...
    public function batchUpdate($field, $ids,array $attributes)
    {
        // Have to skip presenter to get a model not some data
        $temporarySkipPresenter = $this->skipPresenter;
        $this->skipPresenter(true);
        $model = parent::whereIn($field, $ids)->update($attributes);
        $this->skipPresenter($temporarySkipPresenter);
